...
type FakeUserInfoFetcher struct {
	GetUserStub        func(string) (login.User, error)
...
func (fake *FakeUserInfoFetcher) GetUser(arg1 string) (login.User, error) {
...
func (fake *FakeUserInfoFetcher) GetUserCalls(stub func(string) (login.User, error)) {
	fake.getUserMutex.Lock()
...
func (fake *FakeUserInfoFetcher) GetUserReturns(result1 login.User, result2 error) {
	fake.getUserMutex.Lock()
	defer fake.getUserMutex.Unlock()
...
func (fake *FakeUserInfoFetcher) GetUserReturnsOnCall(i int, result1 login.User, result2 error) {
	fake.getUserMutex.Lock()
	defer fake.getUserMutex.Unlock()
	fake.GetUserStub = nil
